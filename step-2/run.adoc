...
Open 3 terminal windows and start each of the services.
...
After that, select one of the flights and execute all the flow till you book it.

image::web4.png[]

If you finish without any error, means that the application is running correctly, and we can start using the code assistant.